...
<?php
		...
		$cg_slider_comments_elemens_width = $_REQUEST['action9'];
...
<?php
    ...
    echo "<div id='example' style='color:#fff;font-weight:bold;font-size:18px;'><a href='#example'></a><br><br>$cg_ThankYouComment</div>"; 
